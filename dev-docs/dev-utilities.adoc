...
2. The results of that compilation are then placed in a directory that is a peer to cloud.sh and named for the current date (e.g. `./2021-02-21`).
3. A node at the top level of zookeeper is created and named for the caniocal path of this directory to serve as a zkchroot for this deployment.
4. Start solr on ports 8981, 8982, 8983 and 8984 with listening debugger ports on 5001, 5002, 5003, and 5004.
5. Each solr instance will place it's data and solr.log in a corresponding directory such as `./2021-02-21/n1`, `./2021-02-21/n2` etc.
