...
class GenerateUnicodeData extends DefaultTask {
  private static final Logger log = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass())
  
  @InputFile
  File unicodePropsFile
...
"""
    ...
    unicodePropsFile.write(code.trim(), 'UTF-8')
    
    logger.info("Unicode data written to: " + unicodePropsFile)
  }
}
