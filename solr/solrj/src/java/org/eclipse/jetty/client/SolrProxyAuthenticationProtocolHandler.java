...
public class SolrProxyAuthenticationProtocolHandler extends SolrAuthenticationProtocolHandler {
  ...
  public SolrProxyAuthenticationProtocolHandler(HttpClient client)
  {
    this(client, DEFAULT_MAX_CONTENT_LENGTH);
  }

  public SolrProxyAuthenticationProtocolHandler(HttpClient client, int maxContentLength)
  {
