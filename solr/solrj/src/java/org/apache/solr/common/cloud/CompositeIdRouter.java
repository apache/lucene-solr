...
/**
 * CompositeIdRouter partitions ids based on a {@link CompositeIdRouter.SEPARATOR}, hashes each partition and merges the hashes together
 * to map the id to a slice. This allows bucketing of like groups of ids.
 *
 * Allows basic separation split between 32 bits as example given below, or using {@link CompositeIdRouter.bitsSeparator} can specify exact bits
 *
 * Example inputs:
 * user!uniqueid
 * app!user!uniqueid
