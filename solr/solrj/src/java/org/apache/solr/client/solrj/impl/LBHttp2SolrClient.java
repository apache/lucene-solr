 ...
 *
 * Do <b>NOT</b> use this class for indexing in primary/secondary scenarios since documents must be sent to the
 * correct primary; no inter-node routing is done.
 *
