...
public class LukeResponse extends SolrResponseBase {
  ...
  public static class FieldTypeInfo implements Serializable {
    ...
    public boolean isTokenized() {
     ...
     text_ws={fields=[cat],tokenized=true,analyzer=CustomAnalyzer(org.apache.solr.analysis.WhitespaceTokenizerFactory@6d3ca2)},
     alphaOnlySort={fields=[alphaNameSort],tokenized=true,analyzer=CustomAnalyzer(org.apache.solr.analysis.KeywordTokenizerFactory@a7bd3b,
      ...
      textTight={fields=[sku],tokenized=true,analyzer=CustomAnalyzer(org.apache.solr.analysis.WhitespaceTokenizerFactory@5e88f7,
