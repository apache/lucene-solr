...
public class TlogReplayBufferedWhileIndexingTestBase extends AbstractFullDistribZkTestBase {

  private List<StoppableIndexingThread> threads;
  
  public TlogReplayBufferedWhileIndexingTestBase() throws Exception {
    super();
    sliceCount = 1;
    fixShardCount(2);
