...
public abstract class LanguageIdentifierUpdateProcessorFactoryTestCase extends SolrTestCaseJ4 {
  ...
  public void testKeepOrig() throws Exception {
    ...
    SolrInputDocument doc = languagePerFieldDoc();
    SolrInputDocument mappedNoOrig = process(doc);
    ...
    SolrInputDocument mappedKeepOrig = process(doc);
    assertTrue(mappedKeepOrig.containsKey("text_en"));
    assertTrue(mappedKeepOrig.containsKey("text"));
    assertEquals(doc.getFieldValue("text"), mappedKeepOrig.getFieldValue("text_en"));
    ...
    SolrInputDocument mappedIndividual = process(doc);
    ...
    assertEquals(doc.getFieldValue("text"), mappedIndividual.getFieldValue("text_en"));
