...
If you want to use one of the analyzers above, in addition to the dependencies listed for each analyzer, solr-analysis-extras-X.Y.jar from the dist directory is required.
