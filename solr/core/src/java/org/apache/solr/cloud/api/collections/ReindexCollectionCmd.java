  ...
  public void call(ClusterState clusterState, ZkNodeProps message, @SuppressWarnings({"rawtypes"})NamedList results) throws Exception {
    ...
    try {
      ...
      if (ocmh.getDistributedClusterChangeUpdater().isDistributedStateChange()) {
        ocmh.getDistributedClusterChangeUpdater().doSingleStateUpdate(DistributedClusterChangeUpdater.MutatingCommand.CollectionModifyCollection, cmd,
      ...
      if (removeSource) {
        ...
        if (ocmh.getDistributedClusterChangeUpdater().isDistributedStateChange()) {
          ocmh.getDistributedClusterChangeUpdater().doSingleStateUpdate(DistributedClusterChangeUpdater.MutatingCommand.CollectionModifyCollection, props,
              ocmh.cloudManager, ocmh.zkStateReader);
        } else {
