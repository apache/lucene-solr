...
public class MigrateCmd implements OverseerCollectionMessageHandler.Cmd {
  ...
  private void migrateKey(ClusterState clusterState, DocCollection sourceCollection, Slice sourceSlice,
    ...
    String tempCollectionReplica1 = Assign.buildCoreName(tempSourceCollectionName, tempSourceSlice.getName(), Replica.Type.REALTIME, 1);
    ...
    String tempCollectionReplica2 = Assign.buildCoreName(tempSourceCollectionName, tempSourceSlice.getName(), Replica.Type.REALTIME, 2); 
    props = new HashMap<>();
