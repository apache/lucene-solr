...
public class CdcrRequestHandler extends RequestHandlerBase implements SolrCoreAware {
    ...
    Runnable runnable = () -> {
      ...
      try {
        if (!locked)  {
          ...
          //running.set(true);
          String primaryUrl = req.getParams().get(ReplicationHandler.PRIMARY_URL);
          BootstrapCallable bootstrapCallable = new BootstrapCallable(primaryUrl, core);
  ...
  static class BootstrapCallable implements Callable<Boolean>, Closeable {
    ...
    BootstrapCallable(String primaryUrl, SolrCore core) {
    ...
    public Boolean call() throws Exception {
      ...
      try {
        ...
        solrParams.set(ReplicationHandler.PRIMARY_URL, primaryUrl);
