 ...
 */
public class DefaultSearchFieldSR extends BaseSchemaResource implements DefaultSearchFieldResource {
  private static final Logger log = LoggerFactory.getLogger(DefaultSearchFieldSR.class);

  @Inject
  public DefaultSearchFieldSR(SolrQueryRequestDecoder requestDecoder) {
