 ...
 */
public class CopyFieldCollectionSR extends BaseFieldResource implements CopyFieldCollectionResource {
  private static final Logger log = LoggerFactory.getLogger(CopyFieldCollectionSR.class);
  ...
  @Inject
  public CopyFieldCollectionSR(SolrQueryRequestDecoder requestDecoder) {
