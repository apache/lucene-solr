 ...
 */
public class FieldSR extends BaseFieldResource implements FieldResource {
  private static final Logger log = LoggerFactory.getLogger(FieldSR.class);

  private boolean includeDynamic;
  private String fieldName;

  @Inject
  public FieldSR(SolrQueryRequestDecoder requestDecoder) {
