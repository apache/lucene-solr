 ...
 */
public class DefaultSchemaSR extends BaseSchemaResource implements DefaultSchemaResource {
  private static final Logger log = LoggerFactory.getLogger(DefaultSchemaSR.class);

  @Inject
  public DefaultSchemaSR(SolrQueryRequestDecoder requestDecoder) {
