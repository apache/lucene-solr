 ...
 */
public class DynamicFieldSR extends BaseFieldResource implements DynamicFieldResource {
  private static final Logger log = LoggerFactory.getLogger(DynamicFieldSR.class);

  private String fieldNamePattern;

  @Inject
  public DynamicFieldSR(SolrQueryRequestDecoder requestDecoder) {
