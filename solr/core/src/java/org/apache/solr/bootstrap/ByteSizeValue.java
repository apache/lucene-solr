...
public class ByteSizeValue implements Comparable<ByteSizeValue> {
    ...
    private static final Logger deprecationLogger = LoggerFactory.getLogger(ByteSizeValue.class);
    ...
    public static ByteSizeValue parseBytesSizeValue(String sValue, String settingName) throws SolrException {
    ...
    public static ByteSizeValue parseBytesSizeValue(String sValue, ByteSizeValue defaultValue, String settingName)
        ...
        if (lowerSValue.endsWith("k")) {
            ...
            // Missing units:
            throw new IllegalArgumentException("failed to parse setting "+ settingName + " with value "+ sValue + " as a size in bytes");
    ...
    private static ByteSizeValue parse(final String initialInput, final String normalized, final String suffix, ByteSizeUnit unit,
        ...
        try {
            ...
            throw new IllegalArgumentException("failed to parse setting "+ settingName + " with value "+ initialInput + " as a size in bytes", e);
        }
    }
