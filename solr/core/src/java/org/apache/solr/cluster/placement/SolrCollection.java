...
public interface SolrCollection {
   ...
   * {@link PropertyValue.DiskType} for all nodes and only place replicas of this collection on {@link Node}'s for which
   * {@link PropertyValue.DiskType#getHardwareType()} is {@link PropertyValue.DiskType.HardwareType#SSD}.
   */
