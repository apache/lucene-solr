 ...
 *  {@link TotalDiskPropertyValue} using {@link PropertyValueFetcher#fetchProperties} and retrieving (then casting) the
 *  appropriate {@link PropertyValue} fetched from the returned map using the {@link PropertyKey} as key.
 */
public interface TotalDiskPropertyValue extends PropertyValue {
  /**
