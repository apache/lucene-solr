 ...
 * </p>
 */
public class CdcrStandAloneStandAloneUpdateProcessor extends DistributedStandAloneUpdateProcessor implements CdcrUpdateProcessor {

  private static final Logger log = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());

  public CdcrStandAloneStandAloneUpdateProcessor(SolrQueryRequest req, SolrQueryResponse rsp, UpdateRequestProcessor next) {
    super(req, rsp, new AtomicUpdateDocumentMerger(req), next);
  }
