...
public class DistributedZkUpdateProcessor extends DistributedUpdateProcessor {
  ...
  public DistributedZkUpdateProcessor(SolrQueryRequest req,
    ...
    distributedClusterChangeUpdater = zkController.getDistributedClusterChangeUpdater();
                  ...
                  if (ruleExpiryLock.tryLock(10, TimeUnit.MILLISECONDS)) {
                    ...
                    try {
                      ...
                      if (distributedClusterChangeUpdater.isDistributedStateChange()) {
                        ...
                        distributedClusterChangeUpdater.doSingleStateUpdate(DistributedClusterChangeUpdater.MutatingCommand.SliceRemoveRoutingRule, message,
