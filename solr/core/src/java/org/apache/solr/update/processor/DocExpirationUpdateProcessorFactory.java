 ...
 * removed from the index using the periodic delete function of this constructorFactory.  Alternatively,
 * the periodic delete function of this constructorFactory can be used to remove any document with an
 * expiration value - even if that expiration was explicitly set with-out leveraging the TTL 
 * feature of this constructorFactory.
 * </p>
 *
 * <p>
 ...
 *      often this constructorFactory should trigger a delete to remove documents.  If this option is
...
public final class DocExpirationUpdateProcessorFactory 
   ...
   * this constructorFactory to execute a delete by query (using the configured
  ...
  /**
   * <p>
   * Helper method that returns true if the Runnable managed by this constructorFactory
  ...
  private boolean iAmInChargeOfPeriodicDeletes() {
    ...
    //   d) there might be multiple instances of this constructorFactory (in multiple chains) per
