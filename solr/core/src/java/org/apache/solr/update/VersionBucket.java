...
public class VersionBucket {
  ...
  public VersionBucket(int verionLockInMill) {
    this.verionLockInMill = verionLockInMill;
  }
  ...
  public int getVerionLockInMill() {
    return verionLockInMill;
  }

  @VisibleForTesting
  public void setVerionLockInMill(int verionLockInMill) {
    this.verionLockInMill = verionLockInMill;
  }

  public boolean tryLock() {
    if (getVerionLockInMill() > 0) {
      try {
        return lock.tryLock(getVerionLockInMill(), TimeUnit.MILLISECONDS);
