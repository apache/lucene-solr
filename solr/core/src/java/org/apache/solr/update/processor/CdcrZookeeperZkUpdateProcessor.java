 ...
 * </p>
 */
public class CdcrZookeeperZkUpdateProcessor extends DistributedZkUpdateProcessor implements CdcrUpdateProcessor {

  private static final Logger log = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());

  public CdcrZookeeperZkUpdateProcessor(SolrQueryRequest req, SolrQueryResponse rsp, CoreContainer cc, UpdateRequestProcessor next) {
    super(req, rsp, new AtomicUpdateDocumentMerger(req), cc, next);
  }
