...
/** @lucene.internal */
/**
 * This implementation uses lock and condition and will throw exception if can't obtain the lock within
...
public class TimedVersionBucket extends VersionBucket {
  ...
  /**
   * This will run the function with the lock, It will throw exception if can't obtain the lock within
   * <code>lockTimeoutMs</code>.
   */
  @Override
