...
public abstract class DocValuesAcc extends SlotAcc {
  ...
  static abstract class LongSortedNumericDVAcc extends DocValuesAcc.SortedNumericDVAcc {
    long[] result;
    long initialValue;
   ...
   */
  static abstract class SDVSortedNumericAcc extends DocValuesAcc.DoubleSortedNumericDVAcc {
    int[] counts;
    double[] sum;
  ...
  static abstract class LongSortedSetDVAcc extends DocValuesAcc.SortedSetDVAcc {
    long[] result;
    long initialValue;
