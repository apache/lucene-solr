...
public class UniqueBlockFieldAgg extends UniqueBlockAgg {
  ...
  private static final class UniqueBlockFieldSlotAcc extends UniqueBlockSlotAcc {
    private UniqueBlockFieldSlotAcc(FacetContext fcontext, SchemaField field, int numSlots)
        throws IOException { //  
  ...
  public SlotAcc createSlotAcc(FacetContext fcontext, int numDocs, int numSlots) throws IOException {
    ...
    if (sf.multiValued() || sf.getType().multiValuedFieldCache()) {
      ...
      if (sf.getType().getNumberType() != null) {
        ...
        return new UniqueBlockFieldSlotAcc(fcontext, sf, numSlots);
      }
    }
  }
}
