...
// root filter lists (for filter exclusions), etc?
  ...
  static abstract class FacetSortableMerger extends FacetMerger {
  ...
  static abstract class FacetDoubleMerger extends FacetSortableMerger {
    @Override
    ...
    public int compare(double a, double b, FacetRequest.SortDirection direction) {
      if (a < b) return -1;
      if (a > b) return 1;
  ...
  static abstract class FacetBucketMerger<FacetRequestT extends FacetRequest> extends FacetMerger {
    FacetRequestT freq;
