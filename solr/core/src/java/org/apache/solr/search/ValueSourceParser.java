  ...
  static {
    ...
    addParser("gt", new ValueSourceParser() {
      ...
      public ValueSource parse(FunctionQParser fp) throws SyntaxError {
        ...
        return new ComparisonPredicate(lhsValSource, rhsValSource, "gt") {
          @Override
    ...
    addParser("lt", new ValueSourceParser() {
      ...
      public ValueSource parse(FunctionQParser fp) throws SyntaxError {
        ...
        return new ComparisonPredicate(lhsValSource, rhsValSource, "lt") {
          @Override
          public boolean compare(double lhs, double rhs) {
            return lhs < rhs;
          }
    ...
    addParser("gte", new ValueSourceParser() {
      ...
      public ValueSource parse(FunctionQParser fp) throws SyntaxError {
        ...
        return new ComparisonPredicate(lhsValSource, rhsValSource, "gte") {
          @Override
          public boolean compare(double lhs, double rhs) {
            return lhs >= rhs;
          }
    ...
    addParser("lte", new ValueSourceParser() {
      ...
      public ValueSource parse(FunctionQParser fp) throws SyntaxError {
        ...
        return new ComparisonPredicate(lhsValSource, rhsValSource, "lte") {
          @Override
          public boolean compare(double lhs, double rhs) {
            return lhs <= rhs;
          }
    ...
    addParser("eq", new ValueSourceParser() {
      ...
      public ValueSource parse(FunctionQParser fp) throws SyntaxError {
        ...
        return new ComparisonPredicate(lhsValSource, rhsValSource, "eq") {
          @Override
          public boolean compare(double lhs, double rhs) {
            return lhs == rhs;
          }
