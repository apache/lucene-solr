...
//import org.apache.solr.store.blob.metadata.SharedStoreResolutionUtil.Action;
//import org.apache.solr.store.blob.metadata.ServerSideMetadata.CoreConfigFileData;
...
//
//    /**
//     * Tests that passing both local and blob as null to {@link SharedStoreResolutionUtil} throws exception.
//     */
//    @Test
//    public void testBothLocalAndBlobAreNull() throws Exception {
//        try {
//            new SharedStoreResolutionUtil(null, null);
...
//
//    /**
//     * Tests that re-resolving an instance of {@link SharedStoreResolutionUtil} throws exception.
//     */
//    @Test
...
//        final SharedStoreResolutionUtil resolver = new SharedStoreResolutionUtil(null, blobMetadata);
//        try {
...
//
//    /**
//     * Tests that a null blob core resolves into {@link SharedStoreResolutionUtil.Action#PUSH}.
//     */
//    @Test
...
//        // local core metadata
//        final ServerSideMetadata serverMetadata = new ServerSideCoreMetadataBuilder(CORE_NAME, /* localSequenceNumber, */ localGenerationNumber)
...
//
//        // resolve
//        final SharedStoreResolutionUtil resolver = new SharedStoreResolutionUtil(serverMetadata, null);
//
//        // assert
...
//
//        // resolve
//        final SharedStoreResolutionUtil resolver = new SharedStoreResolutionUtil(serverMetadata, blobMetadata);
//
//        // assert
//        assertMetadataResolver(expectedAction, expectedFilesToPush, expectedFilesToPull, expectedConfigFilesToPush,
//                expectedConfigFilesToPull, expectedFilesToDelete, expectedMessage, resolver);
...
//                                               String expectedMessage,  SharedStoreResolutionUtil actual) throws Exception {
...
//
//    /**
//     * A builder for {@link ServerSideMetadata} that uses mock.
//     */
