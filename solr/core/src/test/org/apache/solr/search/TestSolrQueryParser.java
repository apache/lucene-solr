...
public class TestSolrQueryParser extends SolrTestCaseJ4 {
  ...
  public void testSynonymsBoostByPayload_singleTermQuerySingleTermSynonyms_shouldParseBoostedQuery() throws Exception {
    ...
    assertEquals("((t_pick_best_boost_by_payload_foo:lince)^0.8 | (t_pick_best_boost_by_payload_foo:lynx_canadensis)^0.9)", q.toString());
  ...
  public void testSynonymsBoostByPayload_singleTermQueryMultiTermSynonyms_shouldParseBoostedQuery() throws Exception {
    ...
    assertEquals("((t_pick_best_boost_by_payload_foo:\"big cat\")^0.8 | (t_pick_best_boost_by_payload_foo:bagheera)^0.9 | (t_pick_best_boost_by_payload_foo:\"panthera pardus\")^0.85 | t_pick_best_boost_by_payload_foo:leopard)", q.toString());
  ...
  public void testSynonymsBoostByPayload_multiTermQueryMultiTermSynonyms_shouldParseBoostedQuery() throws Exception {
    //leopard, big cat|0.8, bagheera|0.9, panthera pardus|0.85
    //lion => panthera leo|0.9, simba leo|0.8, kimba|0.75
    Query q = QParser.getParser("leopard lion", req(params("df", "t_pick_best_boost_by_payload_foo"))).getQuery();
    assertEquals("((t_pick_best_boost_by_payload_foo:\"big cat\")^0.8 | (t_pick_best_boost_by_payload_foo:bagheera)^0.9 | (t_pick_best_boost_by_payload_foo:\"panthera pardus\")^0.85 | t_pick_best_boost_by_payload_foo:leopard)" +
        " ((t_pick_best_boost_by_payload_foo:\"panthera leo\")^0.9 | (t_pick_best_boost_by_payload_foo:\"simba leo\")^0.8 | (t_pick_best_boost_by_payload_foo:kimba)^0.75)", q.toString());
  ...
  public void testSynonymsBoostByPayload_singleConceptQueryMultiTermSynonyms_shouldParseBoostedQuery() throws Exception {
    ...
    Query q = QParser.getParser("snow leopard",req(params("df", "t_pick_best_boost_by_payload_foo","sow", "false"))).getQuery();
    assertEquals("((t_pick_best_boost_by_payload_foo:\"panthera uncia\")^0.9 | (t_pick_best_boost_by_payload_foo:\"big cat\")^0.8 | (t_pick_best_boost_by_payload_foo:white_leopard)^0.6 | t_pick_best_boost_by_payload_foo:\"snow leopard\")", q.toString());
  ...
  public void testSynonymsBoostByPayload_multiConceptsQueryMultiTermSynonyms_shouldParseBoostedQuery() throws Exception {
    //snow leopard|1.0, panthera uncia|0.9, big cat|0.8, white_leopard|0.6
    //panthera onca => jaguar|0.95, big cat|0.85, black panther|0.65
    Query q = QParser.getParser("snow leopard panthera onca",req(params("df", "t_pick_best_boost_by_payload_foo","sow", "false"))).getQuery();
    assertEquals("((t_pick_best_boost_by_payload_foo:\"panthera uncia\")^0.9 | (t_pick_best_boost_by_payload_foo:\"big cat\")^0.8 | (t_pick_best_boost_by_payload_foo:white_leopard)^0.6 | t_pick_best_boost_by_payload_foo:\"snow leopard\")" +
        " ((t_pick_best_boost_by_payload_foo:jaguar)^0.95 | (t_pick_best_boost_by_payload_foo:\"big cat\")^0.85 | (t_pick_best_boost_by_payload_foo:\"black panther\")^0.65)", q.toString());
  ...
  public void testSynonymsBoostByPayload_edismaxBoost_shouldParseBoostedPhraseQuery() throws Exception {
    ...
    assertEquals("+(" +
        "((((t_pick_best_boost_by_payload_foo:\"panthera uncia\")^0.9 | (t_pick_best_boost_by_payload_foo:\"big cat\")^0.8 | (t_pick_best_boost_by_payload_foo:white_leopard)^0.6 | t_pick_best_boost_by_payload_foo:\"snow leopard\"))^10.0)" +
        " ((((t_pick_best_boost_by_payload_foo:\"panthera leo\")^0.9 | (t_pick_best_boost_by_payload_foo:\"simba leo\")^0.8 | (t_pick_best_boost_by_payload_foo:kimba)^0.75))^10.0)" +
        ")", q.toString());

    q = QParser.getParser("snow leopard lion","edismax",true, req(params("sow", "false","qf", "t_as_distinct_boost_by_payload_foo^10"))).getQuery();
    assertEquals("+(" +
  ...
  public void testSynonymsBoostByPayload_phraseQueryMultiTermSynonymsPayloadBoost_shouldParseBoostedSpanQuery() throws Exception {
    Query q = QParser.getParser("\"snow leopard lion\"", req(params("df", "t_pick_best_boost_by_payload_foo", "sow", "false"))).getQuery();
    assertEquals("spanNear([" +
        "spanOr([" +
        "(spanNear([t_pick_best_boost_by_payload_foo:panthera, t_pick_best_boost_by_payload_foo:uncia], 0, true))^0.9," +
        " (spanNear([t_pick_best_boost_by_payload_foo:big, t_pick_best_boost_by_payload_foo:cat], 0, true))^0.8," +
        " (t_pick_best_boost_by_payload_foo:white_leopard)^0.6," +
        " spanNear([t_pick_best_boost_by_payload_foo:snow, t_pick_best_boost_by_payload_foo:leopard], 0, true)])," +
        " spanOr([" +
        "(spanNear([t_pick_best_boost_by_payload_foo:panthera, t_pick_best_boost_by_payload_foo:leo], 0, true))^0.9," +
        " (spanNear([t_pick_best_boost_by_payload_foo:simba, t_pick_best_boost_by_payload_foo:leo], 0, true))^0.8," +
        " (t_pick_best_boost_by_payload_foo:kimba)^0.75])], 0, true)", q.toString());
  }

  public void testSynonymsBoostByPayload_PayloadBoostMissing_shouldAssignDefaultBoost() throws Exception {
    //leopard, big cat|0.8, bagheera|0.9, panthera pardus|0.85
    Query q = QParser.getParser("leopard", req(params("df", "t_pick_best_boost_by_payload_foo"))).getQuery();
    assertEquals("((t_pick_best_boost_by_payload_foo:\"big cat\")^0.8 | (t_pick_best_boost_by_payload_foo:bagheera)^0.9 | (t_pick_best_boost_by_payload_foo:\"panthera pardus\")^0.85 | t_pick_best_boost_by_payload_foo:leopard)", q.toString());
