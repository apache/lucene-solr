...
public class SimpleMLTQParserTest extends SolrTestCaseJ4 {
  ...
  public void doTest() throws Exception {
    ...
    params = new ModifiableSolrParams();
    params.set(CommonParams.Q, "{!mlt qf=lowerfilt,lowerfilt1^1000 boost=false mintf=0}30");
    assertQ(req(params), 
        "//result/doc[1]/int[@name='id'][.='13']",
        "//result/doc[2]/int[@name='id'][.='14']",
        "//result/doc[3]/int[@name='id'][.='18']",
        "//result/doc[4]/int[@name='id'][.='20']",
        "//result/doc[5]/int[@name='id'][.='22']",
        "//result/doc[6]/int[@name='id'][.='23']",
        "//result/doc[7]/int[@name='id'][.='15']",
        "//result/doc[8]/int[@name='id'][.='16']",
        "//result/doc[9]/int[@name='id'][.='19']",
        "//result/doc[10]/int[@name='id'][.='21']"
    );

    params = new ModifiableSolrParams();
    params.set(CommonParams.Q, "{!mlt qf=lowerfilt,lowerfilt1^1000 boost=true mintf=0}30");
    assertQ(req(params), 
        "//result/doc[1]/int[@name='id'][.='13']",
        "//result/doc[2]/int[@name='id'][.='14']",
        "//result/doc[3]/int[@name='id'][.='18']",
