...
public class AutoAddReplicasIntegrationTest extends SolrCloudTestCase {
  ...
  public void testSimple() throws Exception {
    ...
    waitForNodeLeave(lostNodeName);
    waitForState("Waiting for collection " + COLLECTION1, COLLECTION1, clusterShape(2, 4), 30, TimeUnit.SECONDS);
    waitForState("Waiting for collection " + COLLECTION2, COLLECTION2, clusterShape(2, 4), 30, TimeUnit.SECONDS);
