...
public class AuditLoggerPluginTest {
  ...
  public void init() {
    ...
    plugin.init(config);
    assertTrue(plugin.shouldLog(EVENT_REJECTED));
    assertFalse(plugin.shouldLog(EVENT_UNAUTHORIZED));
  }

  @Test
  public void shouldLog() {
    // Default types
    assertTrue(plugin.shouldLog(EVENT_ANONYMOUS_REJECTED));
    assertTrue(plugin.shouldLog(EVENT_REJECTED));
    assertTrue(plugin.shouldLog(EVENT_UNAUTHORIZED));
    assertTrue(plugin.shouldLog(EVENT_ERROR));
    assertFalse(plugin.shouldLog(EVENT_ANONYMOUS));    
    assertFalse(plugin.shouldLog(EVENT_AUTHENTICATED));    
    assertFalse(plugin.shouldLog(EVENT_AUTHORIZED));
  }
