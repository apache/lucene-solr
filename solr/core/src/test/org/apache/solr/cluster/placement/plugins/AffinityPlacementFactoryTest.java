...
public class AffinityPlacementFactoryTest extends SolrTestCaseJ4 {
  ...
  public void testNodeType() throws Exception {
    ...
    collectionBuilder.addCustomProperty(AffinityPlacementConfig.COLLECTION_NODE_TYPE_PROPERTY, "type_0");
    clusterBuilder.addCollection(collectionBuilder);
    ...
    collectionBuilder.addCustomProperty(AffinityPlacementConfig.COLLECTION_NODE_TYPE_PROPERTY, "type_0,type_1");
