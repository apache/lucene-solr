 ...
 * and the convinient {@link #getNode(SolrResourceLoader, String, String)} method.
 */
...
//    NodeInfo node = getNode(clu  configWith2Children, "plugin");
...
//    NodeInfo node = getNode(TE configWith2Children, "plugin");
