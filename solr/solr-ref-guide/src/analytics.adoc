...
The Analytics framework is a <<requesthandlers-and-searchcomponents-in-solrconfig.adoc#search-components,Search Component>>, and is included as a default so no special configuration is needed to use.
