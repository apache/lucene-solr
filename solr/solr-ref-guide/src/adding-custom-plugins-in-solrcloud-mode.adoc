...
== Using external service to host your jars

Step 1: download a jar from github
...
Step 4: run a local server. skip this step if you have another place to host your jars
...
[source,bash]
----
 #add the jar to your collection 'gettingstarted'
