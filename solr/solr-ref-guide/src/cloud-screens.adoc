...
Click on the Cloud option in the left-hand navigation, and a small sub-menu appears with options called "Nodes", "Tree" and "Graph". The default view ("Nodes") shows a list of the hosts and nodes in the cluster along with key information for each: "CPU", "Heap", "Disk usage", "Requests", "Collections" and "Replicas".
...
image::images/cloud-screens/cloud-nodes.png[image,width=512,height=236]
