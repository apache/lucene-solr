...
[NOTE]
====
Do not allocate a very large Java Heap unless you know you need it. See <<jvm-settings.adoc#choosingmemory-heap-settings,Choosing Memory Heap Settings>> for details.
====
