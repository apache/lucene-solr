...
SolrCloud users should not typically use the CoreAdmin API directly, but the API may be useful for users of single-node or master/follower Solr installations for core maintenance operations.
