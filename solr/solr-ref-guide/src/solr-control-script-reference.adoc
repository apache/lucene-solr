...
`-blockUnknown`::
When *true*, blocks all unauthenticated users from accessing Solr. This defaults to *true*, which means unauthenticated users will not be able to access Solr.
