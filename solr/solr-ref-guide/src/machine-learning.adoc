...
insight in the clusters of rat sightings throughout the boroughs of New York City. For
...
to extract the latitude and longitude columns by index from the matrix and
