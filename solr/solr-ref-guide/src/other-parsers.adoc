...
There are two query parsers that support block joins. These parsers allow indexing and searching for relational content that has been <<nested-documents.adoc#nested-documents, indexed as Nested Documents>>.
