...
The `upper` `lower`, `split`, `valueAt` and `trim` functions can be used to manipulate
...
In most cases nulls do not need to be handled unless there is specific logic needed
