...
can be easily visualized as scatter plots to gain an intuitive understanding
...
The next example shows a scatter plot of a uniform distribution between
the ranges of -5 and 5.

image::images/math-expressions/sample-scatter1.png[]

The next example shows the two samples overlaid in the same scatter
plot.
