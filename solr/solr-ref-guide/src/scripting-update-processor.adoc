...
The {solr-javadocs}/contrib/scripting-update-processor/org/apache/solr/update/processor/ScriptUpdateProcessorFactory.html[ScriptUpdateProcessor] allows Java scripting engines to be used
...
`req`::
{solr-javadocs}/core/org/apache/solr/request/SolrQueryResponse.html[SolrQueryRequest] instance.
