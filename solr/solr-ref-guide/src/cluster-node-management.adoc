...
NOTE: Until Solr 7.5, cluster properties supported a `collectionDefaults` parameter which is now deprecated and
...
Support for the `collectionDefaults` will be removed in Solr 9.
