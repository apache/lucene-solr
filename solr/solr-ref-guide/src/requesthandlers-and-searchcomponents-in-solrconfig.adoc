...
|get |`solr.RealTimeGetComponent` | Described in the section <<realtime-get.adoc#realtime-get,RealTime Get>>.
|responselog |`solr.ResponseLogComponent` | Learn more in the {solr-javadocs}org/apache/solr/handler/component/ResponseLogComponent.html[ResponseLogComponent] java class.
|===

Lastly, you may be interested in some of the components hosted on the https://solr.cool/#searchcomponents[Solr Cool] website.
