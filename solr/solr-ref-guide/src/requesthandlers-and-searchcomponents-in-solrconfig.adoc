...
The {solr-javadocs}/solr-core/org/apache/solr/handler/component/DelegatingSearchComponent.html[DelegatingSearchComponent] can be configured to support selective use of alternative components in the same SearchHandler.
