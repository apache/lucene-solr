...
the logs collection. The fields are vectorized into the variables *x* and *y* and then the covariance for
...
function call. The example below demonstrates the use of the `corr` function with the *type*
named parameter.
