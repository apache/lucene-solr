...
`/admin/collections?action=ALIASPROP&name=_name_&properties.someKey=somevalue`
...
[source,text]
----
http://localhost:8983/solr/admin/collections?action=ALIASPROP&name=testalias2&properties.someKey=someValue&properties.otherKey=otherValue&wt=xml
----
