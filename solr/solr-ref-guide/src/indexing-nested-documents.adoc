...
[source,bash]
----
curl -X POST -d @example/exampledocs/office_products.json 'http://localhost:8983/solr/techproducts/update/json?commit=true'
curl -X GET 'http://localhost:8983/solr/techproducts/select?q=id:P11!prod&fl=*,[child]'
----
====
