...
[source,bash]
----
curl -X GET http://localhost:8983/api/collections?omitHeader=true
----
====
--
...
[source,bash]
----
http://localhost:8983/solr/admin/collections?action=RENAME&name=newCollection&target=renamedCollection
----
====
...
With the v1 API, the `collectionprop` command must be capitalized as `COLLECTIONPROP`:

[source,bash]
----
http://localhost:8983/solr/admin/collections?action=COLLECTIONPROP&name=newCollection&propertyName=propertyName&propertyValue=propertyValue
----
====
...
With the v1 API, the `migrate` command must be capitalized as `MIGRATE`:

[source,bash]
----
http://localhost:8983/solr/admin/collections?action=MIGRATE&collection=newCollection&split.key=key1!&target.collection=postMigrationCollection&forward.timeout=60
----
====
...
With the v1 API, the `reindexcommand` command must be capitalized as `REINDEXCOLLECTION`:

[source,bash]
----
http://localhost:8983/solr/admin/collections?action=REINDEXCOLLECTION&name=newCollection
----
====
...
With the v1 API, the `colstatus` command must be capitalized as `COLSTATUS`:

[source,bash]
----
http://localhost:8983/solr/admin/collections?action=COLSTATUS&collection=newCollection&coreInfo=true&segments=true&fieldInfo=true&sizeInfo=true
----
====
...
[source,bash]
----
curl -X GET http://localhost:8983/api/collections/newCollection?omitHeader=true
----
====
--
