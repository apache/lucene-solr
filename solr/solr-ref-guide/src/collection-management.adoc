...
[source,bash]
----
curl -X POST http://localhost:8983/api/collections/techproducts_v2?omitHeader=true -H 'Content-Type: application/json' -d'
  {
    "reload": {}
  }
'
...
[source,bash]
----
curl -X DELETE http://localhost:8983/api/collections/techproducts_v2?omitHeader=true
----
====
--
...
[source,bash]
----
curl -X GET http://localhost:8983/api/collections/techproducts_v2?omitHeader=true
----
====
--
...
[source,bash]
----
curl -X POST http://localhost:8983/api/collections/techproducts?omitHeader=true -H 'Content-Type: application/json' -d'
  {
    "rebalance-leaders": {
      "maxAtOnce": 3
    }
