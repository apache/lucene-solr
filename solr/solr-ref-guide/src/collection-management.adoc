...
[source,bash]
----
http://localhost:8983/solr/admin/collections?action=CREATE&name=newCollection&numShards=1
...
http://localhost:8983/solr/admin/collections?action=modifycollection&collection=newCollection&replicationFactor=2
