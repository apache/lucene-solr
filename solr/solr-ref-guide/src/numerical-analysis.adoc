...
price changes over time. As the slope of the curve increases, volume under curve is being
added at an increasing rate, which signifies rising prices. As the slope of the curve decreases,
it signifies decreasing rate of volume added to the curve, or falling prices.
