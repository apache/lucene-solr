...
public class TestHighFreqTerms extends LuceneTestCase {
    ...
    writer =
        new IndexWriter(
            ...
            newIndexWriterConfig(
                    random(), new MockAnalyzer(random(), MockTokenizer.WHITESPACE, false))
  ...
  public void testFirstTermHighestTotalTermFreq() throws Exception {
    ...
    TermStats[] terms =
        HighFreqTerms.getHighFreqTerms(
            reader, numTerms, field, new HighFreqTerms.TotalTermFreqComparator());
  ...
  public void testFirstTermHighestTotalTermFreqDifferentField() throws Exception {
    ...
    TermStats[] terms =
        HighFreqTerms.getHighFreqTerms(
            reader, numTerms, field, new HighFreqTerms.TotalTermFreqComparator());
    assertEquals(
        "Term with highest totalTermFreq is first" + terms[0].getTermText(),
        150,
  ...
  /**
   * getContent return string containing numbers 1 to i with each number n occurring n times. i.e.
   * for input of 3 return string "3 3 3 2 2 1"
   */
