...
public class Geo3dShapeFactory implements ShapeFactory {
  ...
  private class Geo3dPolygonBuilder extends Geo3dPointBuilder<PolygonBuilder> implements PolygonBuilder {
    ...
    List<HoleBuilder> holeBuilders = new ArrayList<>();

    public Geo3dPolygonBuilder() {
    }

    public Geo3dPolygonBuilder(List<GeoPoint> points) {
      this.points = points;
    }

    @Override
    public HoleBuilder hole() {
      HoleBuilder builder = new Geo3dHoleBuilder();
      holeBuilders.add(builder);
      return builder;
    }
  ...
  /**
   * Geo3d implementation of {@link org.locationtech.spatial4j.shape.ShapeFactory.PolygonBuilder.HoleBuilder} to generate
   * polygon holes
   */
  private class Geo3dHoleBuilder extends Geo3dPointBuilder<PolygonBuilder.HoleBuilder> implements PolygonBuilder.HoleBuilder {

    @Override
    public PolygonBuilder endHole() {
      return new Geo3dPolygonBuilder(points);
    }
  }

  class Geo3dMultiPointBuilder extends Geo3dPointBuilder<MultiPointBuilder> implements MultiPointBuilder {

    public Geo3dMultiPointBuilder() {
    }
   ...
   * multi-lines
   */
  class Geo3dMultiLineBuilder implements MultiLineStringBuilder {

    List<LineStringBuilder> builders = new ArrayList<>();

    public Geo3dMultiLineBuilder() {
    }
   ...
   * ii might be possible to use GeoComplexPolygon.
   */
