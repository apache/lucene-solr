...
public class RandomCodec extends AssertingCodec {
      ...
      public PointsWriter fieldsWriter(SegmentWriteState writeState) throws IOException {
        ...
        return new Lucene60PointsWriter(writeState, maxPointsInLeafNode, maxMBSortInHeap) {
          ...
          public void writeField(FieldInfo fieldInfo, PointsReader reader) throws IOException {
            ...
            try (BKDWriter writer = new RandomlySplittingBKDWriter(config,
  ...
  private static class RandomlySplittingBKDWriter extends BKDWriter {
    ...
    public RandomlySplittingBKDWriter(BKDConfig config, int maxDoc, Directory tempDir, String tempFileNamePrefix, double maxMBSortInHeap,
                                      long totalPointCount, int randomSeed) throws IOException {
      super(config, maxDoc, tempDir, tempFileNamePrefix, maxMBSortInHeap, totalPointCount);
