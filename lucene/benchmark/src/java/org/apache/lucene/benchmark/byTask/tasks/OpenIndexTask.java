 ...
 *
 * <p>Accepts a param specifying the commit point as previously saved with CommitIndexTask. If you
 * specify this, it rolls the index back to that commit on opening the IndexWriter.
 */
public class OpenIndexTask extends PerfTask {
  ...
  public static final double DEFAULT_RAM_FLUSH_MB =
      (int) IndexWriterConfig.DEFAULT_RAM_BUFFER_SIZE_MB;
  ...
  public int doLogic() throws IOException {
    ...
    final IndexWriter writer =
        CreateIndexTask.configureWriter(config, runData, OpenMode.APPEND, ic);
