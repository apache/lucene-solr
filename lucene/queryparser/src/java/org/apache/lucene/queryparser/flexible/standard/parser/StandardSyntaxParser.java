...
public class StandardSyntaxParser implements SyntaxParser, StandardSyntaxParserConstants {
  ...
  final private QueryNode Query(CharSequence field) throws ParseException {
  ...
  QueryNode node;
    ...
    {if (true) return clauses.size() == 1 ? clauses.get(0) : new BooleanQueryNode(clauses);}
    throw new Error("Missing return statement in function");
  }

  final private QueryNode DisjQuery(CharSequence field) throws ParseException {
  ArrayList<QueryNode> clauses = new ArrayList<>();
  QueryNode node;
    ...
    {if (true) return clauses.size() == 1 ? clauses.get(0) : new OrQueryNode(clauses);}
    throw new Error("Missing return statement in function");
  }

  final private QueryNode ConjQuery(CharSequence field) throws ParseException {
  ArrayList<QueryNode> clauses = new ArrayList<>();
  QueryNode node;
    ...
    {if (true) return clauses.size() == 1 ? clauses.get(0) : new AndQueryNode(clauses);}
    throw new Error("Missing return statement in function");
  }

  final private QueryNode ModClause(CharSequence field) throws ParseException {
  QueryNode q;
  ...
  final private CharSequence FieldName() throws ParseException {
  Token name;
    name = jj_consume_token(TERM);
                  {if (true) return discardEscapeChar(name.image);}
    throw new Error("Missing return statement in function");
  }

  final private GroupQueryNode GroupingExpr(CharSequence field) throws ParseException {
  QueryNode q;
  Token boost;
    ...
    {if (true) return new GroupQueryNode(q);}
    throw new Error("Missing return statement in function");
  }

  final private QueryNode Boost(QueryNode node) throws ParseException {
  Token boost;
    jj_consume_token(CARAT);
    boost = jj_consume_token(NUMBER);
    {if (true) return applyBoost(node, boost);}
    throw new Error("Missing return statement in function");
  }
  ...
  Token similarity = null;
    ...
    {if (true) return new FuzzyQueryNode(field, discardEscapeChar(term.image), fms, term.beginColumn, term.endColumn);}
    throw new Error("Missing return statement in function");
  }

  final private TermRangeQueryNode FieldRangeExpr(CharSequence field) throws ParseException {
  Token operator, term;
  ...
  boolean lowerInclusive, upperInclusive;
    ...
    {if (true) return new TermRangeQueryNode(qLower, qUpper, lowerInclusive, upperInclusive);}
    throw new Error("Missing return statement in function");
  }

  final private QueryNode Term(CharSequence field) throws ParseException {
  QueryNode q;
  ...
  final private QueryNode QuotedTerm(CharSequence field) throws ParseException {
  QueryNode q;
  Token term, slop;
  ...
  final private TermRangeQueryNode TermRangeExpr(CharSequence field) throws ParseException {
  Token left, right;
  ...
  boolean rightInclusive = false;
    ...
    {if (true) return new TermRangeQueryNode(qLower, qUpper, leftInclusive, rightInclusive);}
    throw new Error("Missing return statement in function");
  }
