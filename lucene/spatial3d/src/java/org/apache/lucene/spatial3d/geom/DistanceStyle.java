...
public interface DistanceStyle {
   ...
   * @return the distance
   */
  public default double computeDistance(
  ...
  /**
   * Convert a distance to a form meant for aggregation. This is meant to be used in conjunction
   * with aggregateDistances() and fromAggregationForm(). Distances should be converted to
   * aggregation form before aggregation is attempted, and they should be converted back from
  ...
  /**
   * Aggregate two distances together to produce a "sum". This is usually just an addition
   * operation, but in the case of squared distances it is more complex. Distances should be
  ...
  /**
   * Convert an aggregation form distance value back to an actual distance. This is meant to be used
   * in conjunction with toAggregationForm() and aggregateDistances(). Distances should be converted
   * to aggregation form before aggregation is attempted, and they should be converted back from
   * aggregation form to yield a final result.
   *
   ...
   * The GeoPoint must be in the specified plane.
   *
   * @param planetModel is the planet model.
   * @param distanceValue is the distance to set the new point at, measured from point1 and on the
   *     way to point2.
