...
class dXYZSolid extends BaseXYZSolid {
   ...
   */
  public dXYZSolid(final PlanetModel planetModel, final InputStream inputStream)
      throws IOException {
    this(
        planetModel,
  ...
  public int getRelationship(final GeoShape path) {
    ...
    // The entire locus of points in this shape is on a single plane, so we only need ot look for an
    // intersection with that plane.
