...
public class TestGeoCircle extends LuceneTestCase {
  ...
  public void testCircleBounds() {
    ...
    c =
        GeoCircleFactory.makeGeoCircle(
            PlanetModel.WGS84, -0.005931145568901605, -0.001942031539653079, 1.2991918568260272E-4);
    area =
        GeoAreaFactory.makeGeoArea(
            ...
            1.001100011578687,
            -0.00207467080358696,
            -0.0018136665346280983,
            -0.006067808248760161,
    ...
    c =
        GeoCircleFactory.makeGeoCircle(
            PlanetModel.WGS84, -0.00824379317765984, -0.0011677469001838581, 0.0011530035396910402);
    ...
    c =
        GeoCircleFactory.makeGeoCircle(
            PlanetModel.SPHERE, -0.004431288600558495, -0.003687846671278374, 1.704543429364245E-8);
    xyzb = new XYZBounds();
    c.getBounds(xyzb);
    area =
        GeoAreaFactory.makeGeoArea(
    ...
    c =
        GeoCircleFactory.makeGeoCircle(
            PlanetModel.WGS84,
            -0.0018829770647349636,
            -0.001969499061382591,
    ...
    c =
        GeoCircleFactory.makeGeoCircle(
            PlanetModel.SPHERE,
            -4.211990380885122E-5,
            -0.0022958453508173044,
    ...
    c =
        GeoCircleFactory.makeGeoCircle(
            PlanetModel.SPHERE, 0.005321278689117842, -0.00216937368755372, 1.5306034422500785E-4);
    xyzb = new XYZBounds();
    c.getBounds(xyzb);
    area =
        GeoAreaFactory.makeGeoArea(
    ...
    c =
        GeoCircleFactory.makeGeoCircle(
            PlanetModel.SPHERE,
            -0.0021627146783861745,
            -0.0017298167021592304,
    ...
    c =
        GeoCircleFactory.makeGeoCircle(
            PlanetModel.WGS84, -0.006450320645814321, 0.004660694205115142, 0.00489710732634323);
    // xyzb = new XYZBounds();
    ...
    // xmin=1.0010356621420726, xmax=1.0011141249179447,ymin=-2.5326643901354566E-4,
    // ymax=0.009584741915757169,zmin=-0.011359874956269283, zmax=-0.0015549504447452225
    area =
        GeoAreaFactory.makeGeoArea(
            PlanetModel.WGS84,
            1.0010822580620098,
            1.0010945779732867,
            0.007079167343247293,
            0.007541006774427837,
            -0.0021855011220022575,
    ...
    */
    ...
    c =
        GeoCircleFactory.makeGeoCircle(
            PlanetModel.SPHERE,
            -0.004282454525970269,
            -1.6739831367422277E-4,
    ...
    area =
        GeoAreaFactory.makeGeoArea(
            ...
            xyzb.getMaximumZ());
    assertTrue(
        GeoArea.WITHIN == area.getRelationship(c) || GeoArea.OVERLAPS == area.getRelationship(c));

    // Fourth BKD discovered failure
    c =
        GeoCircleFactory.makeGeoCircle(
            PlanetModel.SPHERE, -0.0048795517261255, 0.004053904306995974, 5.93699764258874E-6);
    xyzb = new XYZBounds();
    c.getBounds(xyzb);
    area =
        GeoAreaFactory.makeGeoArea(
    ...
    c =
        GeoCircleFactory.makeGeoCircle(
            PlanetModel.SPHERE,
            -0.005955031040627789,
            -0.0029274772647399153,
    ...
    c =
        GeoCircleFactory.makeGeoCircle(
            PlanetModel.SPHERE, -0.765816119338, 0.991848766844, 0.8153163226330487);
  ...
  public void testBoundsFailureCase1() {
    ...
    final GeoCircle gc =
        GeoCircleFactory.makeGeoCircle(
            PlanetModel.WGS84, 2.7399499693409367E-13, -3.141592653589793, 2.1814042682464985);
    // With a circle like this, zmin should equal zmax, and xmin should be PlanetModel.minimumX.
    final GeoPoint gp =
        new GeoPoint(0.0054866241253590815, -0.004009749293376541, 0.997739304376186);
  ...
  public void testWholeWorld() {
    ...
    final GeoCircle circle2 =
        GeoCircleFactory.makeGeoCircle(
            PlanetModel.SPHERE, Math.PI * 0.5, Math.PI, 3.141592653589792);
