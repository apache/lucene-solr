  ...
  private void testRandomStrings(final Transliterator transform) throws Exception {
    Analyzer a = new Analyzer() {
      ...
      protected Reader initReader(String fieldName, Reader reader) {
        return super.initReader(fieldName, new ICUTransformCharFilter(reader, transform));
      }

      @Override
      protected Reader initReaderForNormalization(String fieldName, Reader reader) {
        return super.initReaderForNormalization(fieldName, new ICUTransformCharFilter(reader, transform));
      }
