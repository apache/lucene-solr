...
public class TestPhoneticFilterFactory extends BaseTokenStreamTestCase {
  ...
  /**
   * we use "Caverphone2" as it is registered in the REGISTRY as Caverphone, so this effectively
   * tests reflection without package name
   */
  ...
  public void testAlgorithms() throws Exception {
    ...
    assertAlgorithm(
        "Metaphone", "false", "aaa bbb ccc easgasg", new String[] {"A", "B", "KKK", "ESKS"});
    ...
    assertAlgorithm(
        "DoubleMetaphone", "false", "aaa bbb ccc easgasg", new String[] {"A", "PP", "KK", "ASKS"});
    ...
    assertAlgorithm(
        "Soundex", "false", "aaa bbb ccc easgasg", new String[] {"A000", "B000", "C000", "E220"});
    ...
    assertAlgorithm(
        "ColognePhonetic",
        "true",
        "Meier Schmitt Meir Schmidt",
        new String[] {"67", "Meier", "862", "Schmitt", "67", "Meir", "862", "Schmidt"});
    assertAlgorithm(
        "ColognePhonetic",
        "false",
        "Meier Schmitt Meir Schmidt",
    ...
    assertAlgorithm(
        "Nysiis",
        "true",
        "Macintosh Knuth Bart Hurd",
        new String[] {"MCANT", "Macintosh", "NAT", "Knuth", "BAD", "Bart", "HAD", "Hurd"});
    assertAlgorithm(
        "Nysiis",
        "false",
        "Macintosh Knuth Bart Hurd",
