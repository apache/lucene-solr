...
public class TestPhoneticFilter extends BaseTokenStreamTestCase {
  ...
  public void testAlgorithms() throws Exception {
    ...
    assertAlgorithm(
        new Metaphone(), false, "aaa bbb ccc easgasg", new String[] {"A", "B", "KKK", "ESKS"});
    ...
    assertAlgorithm(
        new Soundex(), false, "aaa bbb ccc easgasg", new String[] {"A000", "B000", "C000", "E220"});
    ...
    assertAlgorithm(
        new Nysiis(), false, "aaa bbb ccc easgasg", new String[] {"A", "B", "C", "EASGAS"});
  }

  static void assertAlgorithm(Encoder encoder, boolean inject, String input, String[] expected)
      throws Exception {
          ...
          new Analyzer() {
            ...
            protected TokenStreamComponents createComponents(String fieldName) {
              ...
              return new TokenStreamComponents(
                  tokenizer, new PhoneticFilter(tokenizer, e, random().nextBoolean()));
            }
          };
      checkOneTerm(a, "", "");
      a.close();
