 ...
 * words once with {@link KeywordAttribute#setKeyword(boolean)} set to <code>true</code> and once
 * set to <code>false</code>. This is useful if used with a stem filter that respects the {@link
 * KeywordAttribute} to index the stemmed and the un-stemmed version of a term into the same field.
 */
