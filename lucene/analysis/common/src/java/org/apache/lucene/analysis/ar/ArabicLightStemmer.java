...
public class ArabicLightStemmer {
  ...
  public static final char prefixes[][] = { ("" + ALEF + LAM).toCharArray(), ("" + WAW + ALEF + LAM).toCharArray(),
      ("" + BEH + ALEF + LAM).toCharArray(), ("" + KAF + ALEF + LAM).toCharArray(),
      ("" + FEH + ALEF + LAM).toCharArray(), ("" + LAM + LAM).toCharArray(), ("" + WAW).toCharArray(), };

  public static final char compoundPrefixes[][] = { ("" + WAW + KAF + ALEF + LAM).toCharArray(),
      ("" + WAW + FEH + ALEF + LAM).toCharArray(), ("" + WAW + BEH + ALEF + LAM).toCharArray(),
      ("" + WAW + ALEF + LAM).toCharArray(), ("" + BEH + ALEF + LAM).toCharArray(),
      ("" + KAF + ALEF + LAM).toCharArray(), ("" + FEH + ALEF + LAM).toCharArray(), ("" + ALEF + LAM).toCharArray(),
      ("" + WAW + LAM + LAM).toCharArray(), ("" + LAM + LAM).toCharArray(), };

  public static final char singlePrefixes[][] = { ("" + LAM + ALEF).toCharArray(), ("" + WAW).toCharArray(),
      ("" + KAF).toCharArray(), ("" + FEH).toCharArray(), ("" + LAM).toCharArray(), ("" + BEH).toCharArray(), };

  public static final char suffixes[][] = { ("" + HEH + ALEF).toCharArray(), ("" + ALEF + NOON).toCharArray(),
      ("" + ALEF + TEH).toCharArray(), ("" + WAW + NOON).toCharArray(), ("" + YEH + NOON).toCharArray(),
      ("" + YEH + HEH).toCharArray(), ("" + YEH + TEH_MARBUTA).toCharArray(), ("" + HEH).toCharArray(),
      ("" + TEH_MARBUTA).toCharArray(), ("" + YEH).toCharArray(), };

  public static final char suffixes_set1[][] = { ("" + YEH + ALEF + TEH).toCharArray(), ("" + ALEF + TEH).toCharArray(),
      ("" + ALEF + TEH + HEH).toCharArray(), };

  public static final char suffixes_set2[][] = { ("" + HEH + ALEF).toCharArray(), ("" + WAW + NOON).toCharArray(),
      ("" + WAW + ALEF).toCharArray(), ("" + YEH + NOON).toCharArray(), ("" + ALEF + NOON).toCharArray(),
      ("" + YEH + HEH).toCharArray(), ("" + HEH + MEM).toCharArray(), ("" + YEH).toCharArray(),
      ("" + HEH).toCharArray(), ("" + TEH_MARBUTA).toCharArray(), ("" + ALEF).toCharArray(), };

  public static final char suffixes_set3[][] = { ("" + NOON + ALEF).toCharArray(), ("" + TEH).toCharArray(), };
  ...
  public boolean lightStemSuffix(char s[], int len) {
    ...
    for (int i = 0; i < suffixes_set1.length; i++) {
      if (endsWithCheckLength(s, len, suffixes_set1[i])) {
        ...
        // Stem the suffix Set 1 even it is not validated if not high accuracy
        // is set
  ...
  public boolean stemInfixNoun(char s[], int len) {
    ...
    if (len >= 3) {
      ...
      // Rule 3
      if (len >= 5 && endsWithCheckLength(s, len, ("" + ALEF + YEH + ALEF).toCharArray()) && s[1] != WAW) {
        s2 = Arrays.copyOf(s, len);
        s2[len - 3] = YEH;
        s2[len - 2] = HEH;
      ...
      // Rule 11
      if (len == 5 && s[1] == WAW && s[2] == ALEF && (s[0] != TEH || s[0] != YEH || s[0] != ALEF) && s[4] != HEH) {
        s2 = Arrays.copyOf(s, len);
        delete(s2, 2, len);
        if (validatedStemList.contains(s2, 0, len - 1)) {
          foundInfixRule = true;
      ...
      // Rule 5
      if (len == 4 && s[2] == WAW && !(s[3] == HEH || s[3] == ALEF || s[3] == YEH || s[3] == HAMZA)
  ...
  public boolean stemInfixVerb(char s[], int len) {
    ...
    if (len >= 3) {
      char s2[] = Arrays.copyOf(s, len);
      // Rule 17
      if (len >= 3 && s[2] != ALEF && s[len - 1] != HEH && (s[0] == YEH || s[0] == TEH)) {
        s2[0] = ALEF;
        if (validatedStemList.contains(s2)) {
          foundInfixRule = true;
          str = Arrays.copyOfRange(s2, 0, len);
  ...
  boolean endsWithCheckLength(char s[], int len, char suffix[]) {
    if (len < suffix.length + 2) { // all suffixes require at least 2 characters
                                   // after stemming
      return false;
    } else {
