 ...
 *
 * <p>Supports an external list of stopwords (words that will not be indexed at all), an external
 * list of exclusions (word that will not be stemmed, but indexed) and an external list of word-stem
