...
/**
 * A {@link TokenFilter} that applies {@link NorwegianLightStemmer} to stem Norwegian words.
 *
...
public final class NorwegianLightStemFilter extends TokenFilter {
  ...
  /**
   * Calls {@link #NorwegianLightStemFilter(TokenStream, int) NorwegianLightStemFilter(input,
   * BOKMAAL)}
   */
