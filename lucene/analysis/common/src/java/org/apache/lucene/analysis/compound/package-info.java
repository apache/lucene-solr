 ...
 *
 * <ul>
 *   <li><i>HyphenationCompoundWordTokenFilter</i>: it uses a hyphenation grammar based approach to
 *       find potential word parts of a given word.
 *   <li><i>DictionaryCompoundWordTokenFilter</i>: it uses a brute-force dictionary-only based
 ...
 * HyphenationCompoundWordTokenFilter} uses hyphenation grammars to find potential subwords that a
 ...
 * XML based grammar files at the <a
 * href="http://offo.sourceforge.net/hyphenation/index.html">Objects For Formatting Objects</a>
 * (OFFO) Sourceforge project (direct link to download the pattern files: <a
 * href="http://downloads.sourceforge.net/offo/offo-hyphenation.zip">http://downloads.sourceforge.net/offo/offo-hyphenation.zip</a>
 * ). The files you need are in the subfolder <i>offo-hyphenation/hyph/</i> . <br>
 * Credits for the hyphenation code go to the <a href="http://xmlgraphics.apache.org/fop/">Apache
 * FOP project</a> .
 *
 * <h3>DictionaryCompoundWordTokenFilter</h3>
 *
 * The {@link org.apache.lucene.analysis.compound.DictionaryCompoundWordTokenFilter
 * DictionaryCompoundWordTokenFilter} uses a dictionary-only approach to find subwords in a compound
 ...
 * find at the <a href="http://wiki.services.openoffice.org/wiki/Dictionaries">OpenOffice
 * dictionaries</a> Wiki.
 *
