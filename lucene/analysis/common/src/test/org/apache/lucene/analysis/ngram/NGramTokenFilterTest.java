  ...
  public void testKeepShortTermKeepLongTerm() throws Exception {
    ...
    { // preserveOriginal = true
      ...
      assertTokenStreamContents(
          filter,
          new String[] {
            "a", "bc", "bcd", "cd", "ef", "efg", "fg", "fgh", "gh", "ghi", "hi", "efghi", "jk"
          },
          ...
          new Analyzer() {
            ...
            protected TokenStreamComponents createComponents(String fieldName) {
              ...
              return new TokenStreamComponents(
                  tokenizer, new NGramTokenFilter(tokenizer, min, max, preserveOriginal));
            }
          };
    ...
    Analyzer a =
        new Analyzer() {
          ...
          protected TokenStreamComponents createComponents(String fieldName) {
            ...
            return new TokenStreamComponents(
                tokenizer, new NGramTokenFilter(tokenizer, 2, 15, false));
          }
        };
