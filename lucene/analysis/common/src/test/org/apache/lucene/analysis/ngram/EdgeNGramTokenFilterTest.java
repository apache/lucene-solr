...
public class EdgeNGramTokenFilterTest extends BaseTokenStreamTestCase {
  ...
  public void testFrontRangeOfNgrams() throws Exception {
    ...
    assertTokenStreamContents(
        tokenizer, new String[] {"a", "ab", "abc"}, new int[] {0, 0, 0}, new int[] {5, 5, 5});
  }
  ...
  public void testSmallTokenInStream() throws Exception {
    ...
    assertTokenStreamContents(
        tokenizer, new String[] {"abc", "fgh"}, new int[] {0, 7}, new int[] {3, 10});
  }
  ...
  public void testReset() throws Exception {
    ...
    assertTokenStreamContents(
        filter, new String[] {"a", "ab", "abc"}, new int[] {0, 0, 0}, new int[] {5, 5, 5});
    tokenizer.setReader(new StringReader("abcde"));
    assertTokenStreamContents(
        filter, new String[] {"a", "ab", "abc"}, new int[] {0, 0, 0}, new int[] {5, 5, 5});
  }
          ...
          new Analyzer() {
            ...
            protected TokenStreamComponents createComponents(String fieldName) {
              ...
              return new TokenStreamComponents(
                  tokenizer, new EdgeNGramTokenFilter(tokenizer, min, max, preserveOriginal));
            }
          };
    ...
    Analyzer a =
        new Analyzer() {
          ...
          protected TokenStreamComponents createComponents(String fieldName) {
            ...
            return new TokenStreamComponents(
                tokenizer, new EdgeNGramTokenFilter(tokenizer, 2, 15, false));
          }
        };
