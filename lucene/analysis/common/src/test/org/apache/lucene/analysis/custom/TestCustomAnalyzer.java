...
public class TestCustomAnalyzer extends BaseTokenStreamTestCase {
  ...
  public void testStopWordsFromClasspathWithMap() throws Exception {
    ...
    Map<String, String> stopConfigImmutable =
        Collections.unmodifiableMap(new HashMap<>(stopConfig1));
  ...
  public void testNullTokenizer() throws Exception {
    expectThrows(
        ...
        () -> {
          CustomAnalyzer.builder().withTokenizer((String) null).build();
        });
  }
  ...
  public void testNullTokenizerFactory() throws Exception {
    expectThrows(
        NullPointerException.class,
        () -> {
          CustomAnalyzer.builder().withTokenizer((Class<TokenizerFactory>) null).build();
        });
  }
  ...
  public void testNullParamKey() throws Exception {
    expectThrows(
        NullPointerException.class,
        () -> {
          CustomAnalyzer.builder().withTokenizer("whitespace", null, "foo").build();
        });
  }
