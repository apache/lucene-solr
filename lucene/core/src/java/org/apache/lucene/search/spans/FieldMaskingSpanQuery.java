 ...
 *
 * <p>This can be used to support Queries like {@link SpanNearQuery} or {@link SpanOrQuery} across
...
public final class FieldMaskingSpanQuery extends SpanQuery {
  ...
  private boolean equalsTo(FieldMaskingSpanQuery other) {
    return getField().equals(other.getField()) && getMaskedQuery().equals(other.getMaskedQuery());
  }
