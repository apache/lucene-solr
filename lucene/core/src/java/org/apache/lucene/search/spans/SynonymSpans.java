...
public class SynonymSpans extends DisjunctionSpans {
   ...
   * @param spanSynQuery  The query that provides the subSpans.
   * @param subSpans      Over which the disjunction is to be taken.
   * @param simScorer     To be used for scoring.
   */
  public SynonymSpans(SpanSynonymQuery spanSynQuery, List<Spans> subSpans, SimScorer simScorer) {
    super(spanSynQuery, subSpans);
    this.simScorer = simScorer;
    this.terms = spanSynQuery.getTerms();
  }
