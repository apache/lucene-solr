 ...
 *
 */
class LegacyPacked64 extends PackedInts.MutableImpl {
   ...
   */
  public LegacyPacked64(int valueCount, int bitsPerValue) {
  ...
  public void fill(int fromIndex, int toIndex, long val) {
    ...
    {
      LegacyPacked64 values = new LegacyPacked64(nAlignedValues, bitsPerValue);
