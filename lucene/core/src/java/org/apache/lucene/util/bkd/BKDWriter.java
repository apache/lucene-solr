...
public class BKDWriter implements Closeable {
  ...
  public static final int VERSION_DOCIDS_LITTLE_ENDIAN = 10;
  public static final int VERSION_CURRENT = VERSION_DOCIDS_LITTLE_ENDIAN;
    ...
    public boolean next() throws IOException {
      ...
      while (true) {
        if (docBlockUpto == docsInBlock) {
          ...
          docsInBlock = bkd.readDocIDs(state.in, state.in.getFilePointer(), state.scratchIterator, state.scratchLongs);
