...
public class DirectReader {
   ...
   * {@code bitsPerValue} for each value.  
   */
  public static LongValues getLegacyInstance(RandomAccessInput slice, int bitsPerValue) {
    return getLegacyInstance(slice, bitsPerValue, 0);
  }
   ...
   * decoding {@code bitsPerValue} for each value
   */
  public static LongValues getLegacyInstance(RandomAccessInput slice, int bitsPerValue, long offset) {
    switch (bitsPerValue) {
      case 1:
        return new LegacyDirectPackedReader1(slice, offset);
      case 2:
        return new LegacyDirectPackedReader2(slice, offset);
      case 4:
        return new LegacyDirectPackedReader4(slice, offset);
      case 8:
        return new DirectPackedReader8(slice, offset);
      case 12:
        return new LegacyDirectPackedReader12(slice, offset);
      case 16:
        return new DirectPackedReader16(slice, offset);
      case 20:
        return new LegacyDirectPackedReader20(slice, offset);
      case 24:
        return new LegacyDirectPackedReader24(slice, offset);
      case 28:
        return new LegacyDirectPackedReader28(slice, offset);
      case 32:
        return new DirectPackedReader32(slice, offset);
      case 40:
        return new LegacyDirectPackedReader40(slice, offset);
      case 48:
        return new LegacyDirectPackedReader48(slice, offset);
      case 56:
        return new LegacyDirectPackedReader56(slice, offset);
      case 64:
        return new DirectPackedReader64(slice, offset);
      default:
        throw new IllegalArgumentException("unsupported bitsPerValue: " + bitsPerValue);
  ...
  static final class LegacyDirectPackedReader1 extends LongValues {
    final RandomAccessInput in;
    final long offset;

    LegacyDirectPackedReader1(RandomAccessInput in, long offset) {
      this.in = in;
      this.offset = offset;
    }
  ...
  static final class LegacyDirectPackedReader2 extends LongValues {
    final RandomAccessInput in;
    final long offset;

    LegacyDirectPackedReader2(RandomAccessInput in, long offset) {
      this.in = in;
      this.offset = offset;
    }
  ...
  static final class LegacyDirectPackedReader4 extends LongValues {
    final RandomAccessInput in;
    final long offset;

    LegacyDirectPackedReader4(RandomAccessInput in, long offset) {
      this.in = in;
      this.offset = offset;
    }
  ...
  static final class LegacyDirectPackedReader12 extends LongValues {
    final RandomAccessInput in;
    final long offset;

    LegacyDirectPackedReader12(RandomAccessInput in, long offset) {
      this.in = in;
      this.offset = offset;
    }
  ...
  static final class LegacyDirectPackedReader20 extends LongValues {
    final RandomAccessInput in;
    final long offset;

    LegacyDirectPackedReader20(RandomAccessInput in, long offset) {
      this.in = in;
      this.offset = offset;
    }
  ...
  static final class LegacyDirectPackedReader24 extends LongValues {
    final RandomAccessInput in;
    final long offset;

    LegacyDirectPackedReader24(RandomAccessInput in, long offset) {
      this.in = in;
      this.offset = offset;
    }
  ...
  static final class LegacyDirectPackedReader28 extends LongValues {
    final RandomAccessInput in;
    final long offset;

    LegacyDirectPackedReader28(RandomAccessInput in, long offset) {
      this.in = in;
      this.offset = offset;
    }
  ...
  static final class LegacyDirectPackedReader40 extends LongValues {
    final RandomAccessInput in;
    final long offset;

    LegacyDirectPackedReader40(RandomAccessInput in, long offset) {
      this.in = in;
      this.offset = offset;
    }
  ...
  static final class LegacyDirectPackedReader48 extends LongValues {
    final RandomAccessInput in;
    final long offset;

    LegacyDirectPackedReader48(RandomAccessInput in, long offset) {
      this.in = in;
      this.offset = offset;
    }
  ...
  static final class LegacyDirectPackedReader56 extends LongValues {
    final RandomAccessInput in;
    final long offset;

    LegacyDirectPackedReader56(RandomAccessInput in, long offset) {
      this.in = in;
      this.offset = offset;
    }
