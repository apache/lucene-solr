...
public class CompiledAutomaton implements Accountable {
  private static final long BASE_RAM_BYTES =
      RamUsageEstimator.shallowSizeOfInstance(CompiledAutomaton.class);
  ...
  /**
   * Matcher for quickly determining if a byte[] is accepted. only valid for {@link
   ...
   * numbering is consistent with {@link #runAutomaton}. Only valid for {@link
   * AUTOMATON_TYPE#NORMAL}.
   */
  ...
  // NORMAL:
  /**
   * Return a {@link TermsEnum} intersecting the provided {@link Terms} with the terms accepted by
   * this automaton.
   */
