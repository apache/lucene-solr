...
public final class Version {
   ...
   * @deprecated (8.10.2) Use latest
   */
  @Deprecated
  public static final Version LUCENE_8_10_1 = new Version(8, 10, 1);

  /**
   * Match settings and bugs in Lucene's 8.10.2 release.
   * <p>
   * Use this to get the latest &amp; greatest settings, bug
   * fixes, etc, for Lucene.
   */
  public static final Version LUCENE_8_10_2 = new Version(8, 10, 2);
   ...
   * in your application.
   */
  public static final Version LATEST = LUCENE_8_10_2;
