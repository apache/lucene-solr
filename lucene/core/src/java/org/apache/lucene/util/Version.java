...
public final class Version {
   ...
   * @deprecated (8.6.4) Use latest
   */
  @Deprecated
  public static final Version LUCENE_8_6_3 = new Version(8, 6, 3);

  /**
   * Match settings and bugs in Lucene's 8.6.4 release.
   * <p>
   * Use this to get the latest &amp; greatest settings, bug
   * fixes, etc, for Lucene.
   */
  public static final Version LUCENE_8_6_4 = new Version(8, 6, 4);
   ...
   * in your application.
   */
  public static final Version LATEST = LUCENE_8_6_4;
