...
public final class Version {
   ...
   * @deprecated (8.9.1) Use latest
   */
  @Deprecated
  public static final Version LUCENE_8_9_0 = new Version(8, 9, 0);

  /**
   * Match settings and bugs in Lucene's 8.9.1 release.
   * <p>
   * Use this to get the latest &amp; greatest settings, bug
   * fixes, etc, for Lucene.
   */
  public static final Version LUCENE_8_9_1 = new Version(8, 9, 1);
   ...
   * in your application.
   */
  public static final Version LATEST = LUCENE_8_9_1;
