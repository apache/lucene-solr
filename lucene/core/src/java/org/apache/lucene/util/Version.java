...
public final class Version {
   ...
   * @deprecated (6.0.2) Use latest
   */
  @Deprecated
  public static final Version LUCENE_6_0_1 = new Version(6, 0, 1);

  /**
   * Match settings and bugs in Lucene's 6.0.2 release.
   * <p>
   * Use this to get the latest &amp; greatest settings, bug
   * fixes, etc, for Lucene.
   */
  public static final Version LUCENE_6_0_2 = new Version(6, 0, 2);
   ...
   * in your application.
   */
  public static final Version LATEST = LUCENE_6_0_2;
