...
public final class Version {
   ...
   * @deprecated (8.7.1) Use latest
   */
  @Deprecated
  public static final Version LUCENE_8_7_0 = new Version(8, 7, 0);

  /**
   * Match settings and bugs in Lucene's 8.7.1 release.
   * <p>
   * Use this to get the latest &amp; greatest settings, bug
   * fixes, etc, for Lucene.
   */
  public static final Version LUCENE_8_7_1 = new Version(8, 7, 1);
   ...
   * in your application.
   */
  public static final Version LATEST = LUCENE_8_7_1;
