...
/**
 * Base class for Locking implementation. {@link Directory} uses instances of this class to
 * implement locking.
 *
 * <p>Lucene uses {@link NativeFSLockFactory} by default for {@link FSDirectory}-based index
 * directories.
 *
 ...
 * together!
 *
 * <p>If you suspect that some LockFactory implementation is not working properly in your
 * environment, you can easily test it by using {@link VerifyingLockFactory}, {@link
