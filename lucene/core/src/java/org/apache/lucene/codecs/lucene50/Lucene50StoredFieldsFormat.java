...
public final class Lucene50StoredFieldsFormat extends StoredFieldsFormat {
  ...
  public static enum Mode {
    ...
    /** No compression */
    NO_COMPRESSION,
    /** Trade retrieval speed and space also for compression ratio */
    ZSTD_COMPRESSION
  }
  ...
  StoredFieldsFormat impl(Mode mode) {
    switch (mode) {
      ...
      case NO_COMPRESSION:
        return new CompressingStoredFieldsFormat("Lucene50StoredFieldsNOData", CompressionMode.NO_COMPRESSION, 2, 2, 10);
      case ZSTD_COMPRESSION:
        return new CompressingStoredFieldsFormat("Lucene50StoredFieldsZstdData", CompressionMode.ZSTD_COMPRESSION, 131072, 512, 10);
