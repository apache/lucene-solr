...
public class FieldInfos implements Iterable<FieldInfo> {
  ...
  static final class FieldNumbers {
     ...
     */
    synchronized int addOrGet(String fieldName, int preferredFieldNumber, IndexOptions indexOptions, DocValuesType dvType, int dimensionCount, int indexDimensionCount, int dimensionNumBytes, int vectorDimension, boolean isSoftDeletesField) {
