...
public final class SegmentInfos implements Cloneable, Iterable<SegmentCommitInfo> {
  ...
  public static final SegmentInfos readCommit(Directory directory, ChecksumIndexInput inputCodec, long generation) throws IOException {
    ...
    try {
      ...
      return parseSegmentInfos(directory, format < VERSION_90 ? new EndiannessReverserIndexInput(inputCodec) : inputCodec, infos, format);
    } catch (Throwable t) {
      priorE = t;
    } finally {
  ...
  private static SegmentInfos parseSegmentInfos(Directory directory, DataInput input, SegmentInfos infos, int format) throws IOException {
