      ...
      for(String name : dir.listAll()) {
        if (name.equals(victim) == false) {
          ...
          try(IndexOutput out = dirCopy.createOutput(name, IOContext.DEFAULT);
            ...
            byte[] actualBytes = new byte[wrongBytes];
            in.readBytes(actualBytes, 0, actualBytes.length);
            byte[] randomBytes = new byte[wrongBytes];
            ...
            } while (Arrays.equals(actualBytes, randomBytes));
            out.writeBytes(randomBytes, 0, randomBytes.length);
