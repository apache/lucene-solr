...
public class TestIndexWriterReader extends LuceneTestCase {
  ...
  public void testAddIndexes() throws Exception {
    ...
    IndexWriterConfig iwc = newIndexWriterConfig(new MockAnalyzer(random())).setMaxCommitMergeWaitMillis(0);
    if (iwc.getMaxBufferedDocs() < 20) {
      iwc.setMaxBufferedDocs(20);
    }
    // no merging
  ...
  public void testAddIndexes2() throws Exception {
    ...
    Directory dir1 = getAssertNoDeletesDirectory(newDirectory());
    IndexWriter writer = new IndexWriter(dir1, newIndexWriterConfig(new MockAnalyzer(random())).setMaxCommitMergeWaitMillis(0));

    // create a 2nd index
    Directory dir2 = newDirectory();
    IndexWriter writer2 = new IndexWriter(dir2, newIndexWriterConfig(new MockAnalyzer(random())).setMaxCommitMergeWaitMillis(0));
    createIndexNoClose(!doFullMerge, "index2", writer2);
    writer2.close();
  ...
  public void testDeleteFromIndexWriter() throws Exception {
    ...
    writer = new IndexWriter(dir1, newIndexWriterConfig(new MockAnalyzer(random())).setMaxCommitMergeWaitMillis(0));
  ...
  public void testDuringAddIndexes() throws Exception {
    ...
    final IndexWriter writer = new IndexWriter(
        dir1,
        newIndexWriterConfig(new MockAnalyzer(random())).setMaxCommitMergeWaitMillis(0)
  ...
  public void testNRTOpenExceptions() throws Exception {
    ...
    IndexWriterConfig conf = newIndexWriterConfig(new MockAnalyzer(random())).setMaxCommitMergeWaitMillis(0);
  ...
  public void testTooManySegments() throws Exception {
    ...
    // "sane" mergePolicy:
    IndexWriterConfig iwc = new IndexWriterConfig(new MockAnalyzer(random())).setMaxCommitMergeWaitMillis(0);
