...
public class TestIndriAndQuery extends LuceneTestCase {
  ...
  public void setUp() throws Exception {
    ...
    
    {
      ...
      d4.add(newTextField("body", "A company or college can have a president",
          Field.Store.YES));
  ...
  public void testSimpleQuery1() throws Exception {
    ...
    BooleanClause clause1 = new BooleanClause(tq("body", "george"),
        Occur.SHOULD);
    BooleanClause clause2 = new BooleanClause(tq("body", "washington"),
        Occur.SHOULD);
  ...
  public void testSimpleQuery2() throws Exception {
    ...
    BooleanClause clause1 = new BooleanClause(tq("body", "president"),
        Occur.SHOULD);
    BooleanClause clause2 = new BooleanClause(tq("body", "washington"),
        Occur.SHOULD);
