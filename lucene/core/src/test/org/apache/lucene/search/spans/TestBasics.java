...
public class TestBasics extends LuceneTestCase {
  ...
  public void testSpanNearUnordered() throws Exception {
    checkHits(
        spanNearUnorderedQuery("field", 4, "nine", "six"),
        new int[] {
  ...
  public void testSpanNearOrdered() throws Exception {
    checkHits(
        spanNearOrderedQuery("field", 4, "nine", "six"),
        new int[] {
  ...
  public void testSpanNotNoOverflowOnLargeSpans() throws Exception {
    SpanQuery near = spanNearOrderedQuery("field", 4, "eight", "one");
    SpanQuery query =
        spanNotQuery(near, spanTermQuery("field", "forty"), Integer.MAX_VALUE, Integer.MAX_VALUE);
  ...
  public void testSpanNotWindowOne() throws Exception {
    ...
    checkHits(
        query,
        new int[] {
          840, 842, 843, 844, 845, 846, 847, 848, 849, 1840, 1842, 1843, 1844, 1845, 1846, 1847,
          1848, 1849
        });
