...
public class TestNearSpansOrdered extends LuceneTestCase {
  ...
  public void testNearSpansNext() throws Exception {
    SpanNearQuery q = makeQuery();
    Spans span = q.createWeight(searcher, ScoreMode.COMPLETE_NO_SCORES, Query.Postings.POSITIONS, 1f).getSpans(searcher.getIndexReader().leaves().get(0), SpanWeight.Postings.POSITIONS);
  ...
  public void testOrderedSpanIteration() throws Exception {
    ...
    Spans spans = q.createWeight(searcher, ScoreMode.COMPLETE_NO_SCORES, Query.Postings.POSITIONS, 1f).getSpans(searcher.getIndexReader().leaves().get(0), SpanWeight.Postings.POSITIONS);
  ...
  public void testGaps() throws Exception {
    ...
    q = SpanNearQuery.newOrderedNearQuery(FIELD)
        ...
        .setSlop(1)
        .build();
    spans = q.createWeight(searcher, ScoreMode.COMPLETE_NO_SCORES, Query.Postings.POSITIONS, 1f).getSpans(searcher.getIndexReader().leaves().get(0), SpanWeight.Postings.POSITIONS);
