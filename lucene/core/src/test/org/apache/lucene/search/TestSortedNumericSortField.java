...
public class TestSortedNumericSortField extends LuceneTestCase {
  ...
  public void testEmptyIndex() throws Exception {
    ...
    Sort sort = new Sort(new SortedNumericSortField("sortednumeric", SortField.Type.LONG));
    ...
    for (SortedNumericSelector.Type v : SortedNumericSelector.Type.values()) {
      sort = new Sort(new SortedNumericSortField("sortednumeric", SortField.Type.LONG, false, v));
