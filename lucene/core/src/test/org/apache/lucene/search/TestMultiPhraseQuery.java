...
public class TestMultiPhraseQuery extends LuceneTestCase {
  ...
  public void testNoDocs() throws Exception {
    ...
    assertEquals("Wrong number of hits", 0, searcher.count(q));
  ...
  private void add(String s, String type, RandomIndexWriter writer) throws IOException {
    Document doc = new Document();
    doc.add(newTextField("body", s, Field.Store.YES));
  ...
  private static final Token[] INCR_0_DOC_TOKENS =
      new Token[] {
        makeToken("x", 1),
        makeToken("a", 1),
        makeToken("1", 0),
  ...
  private static final Token[] INCR_0_QUERY_TOKENS_AND =
      new Token[] {
        makeToken("a", 1),
        makeToken("1", 0),
        makeToken("b", 1),
  ...
  private static final Token[][] INCR_0_QUERY_TOKENS_AND_OR_MATCH =
      new Token[][] {
        {makeToken("a", 1)},
  ...
  private static final Token[][] INCR_0_QUERY_TOKENS_AND_OR_NO_MATCHN =
      new Token[][] {
        {makeToken("x", 1)},
