...
public class TestPositionIncrement extends LuceneTestCase {
  ...
  public void testPayloadsPos0() throws Exception {
    ...
    Spans pspans = snq.createWeight(is, ScoreMode.COMPLETE_NO_SCORES, Query.Postings.PAYLOADS, 1f).getSpans(is.getIndexReader().leaves().get(0), SpanWeight.Postings.PAYLOADS);
    ...
    // System.out.println("\ngetSpans test");
    Spans spans = snq.createWeight(is, ScoreMode.COMPLETE_NO_SCORES, Query.Postings.POSITIONS, 1f).getSpans(is.getIndexReader().leaves().get(0), SpanWeight.Postings.POSITIONS);
    count = 0;
    sawZero = false;
