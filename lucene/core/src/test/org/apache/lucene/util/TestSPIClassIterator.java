...
public class TestSPIClassIterator extends LuceneTestCase {
  ...
  private boolean checkNoPerms(final ClassLoader parent, final ClassLoader child) throws Exception {
    return runWithRestrictedPermissions(new PrivilegedExceptionAction<Boolean>() {
      @Override
      public Boolean run() throws Exception {
        return SPIClassIterator.isParentClassLoader(parent, child);
      }
    });
  }
