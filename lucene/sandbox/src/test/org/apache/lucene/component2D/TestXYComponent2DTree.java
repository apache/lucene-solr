...
import org.apache.lucene.document.BaseXYShapeTestCase;
...
public class TestXYComponent2DTree extends TestBaseXYComponent2D {
  ...
  protected Component2D getComponent(Object shape) {
    return XYComponent2DFactory.create((Object[]) shape);
  }

  private Object createRandomShape() {
    int type = random().nextInt(4);
    switch (type) {
      case 0 : return new double[] {ShapeTestUtil.nextDouble(), ShapeTestUtil.nextDouble()};
      case 1 : return ShapeTestUtil.nextBox();
      case 2 : return ShapeTestUtil.nextPolygon();
      case 3 : return BaseXYShapeTestCase.getNextLine();
