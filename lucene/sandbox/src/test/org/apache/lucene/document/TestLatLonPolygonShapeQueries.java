  ...
  protected static class PolygonValidator extends Validator {
    ...
    public boolean testBBoxQuery(double minLat, double maxLat, double minLon, double maxLon, Object shape) {
      ...
      for (Tessellator.Triangle t : tessellation) {
        LatLonShape.Triangle decoded = encodeDecodeTriangle(t.getLon(0), t.getLat(0), t.fromPolygon(0), t.getLon(1), t.getLat(1), t.fromPolygon(1), t.getLon(2), t.getLat(2), t.fromPolygon(2));
    ...
    private boolean testPolygon(EdgeTree tree, Polygon shape) {
      ...
      for (Tessellator.Triangle t : tessellation) {
        double[] qTriangle = quantizeTriangle(t.getLon(0), t.getLat(0), t.fromPolygon(0), t.getLon(1), t.getLat(1), t.fromPolygon(1), t.getLon(2), t.getLat(2), t.fromPolygon(2));
