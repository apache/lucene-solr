...
public class PayloadLengthTermIntervalsSource extends IntervalsSource {
  ...
  public boolean equals(Object o) {
    ...
    PayloadLengthTermIntervalsSource that = (PayloadLengthTermIntervalsSource) o;
   ...
   * per document for the positions and payloads of a term.
   * See also {@link org.apache.lucene.codecs.lucene50.Lucene50PostingsReader.EverythingEnum#nextPosition()}.
   * <p>
  ...
  /** Number of simple operations in {@link org.apache.lucene.codecs.lucene50.Lucene50PostingsReader.EverythingEnum#nextPosition()}
   *  when no seek or buffer refill is done.
   */
  private static final int TERM_OPS_PER_POS = 14;
   ...
   */
  private static float termPositionsCost(TermsEnum termsEnum) throws IOException {
