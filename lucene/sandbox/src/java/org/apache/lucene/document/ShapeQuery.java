...
abstract class ShapeQuery extends Query {
  ...
  protected abstract boolean queryMatches(byte[] triangle, ShapeField.EncodedTriangle scratchTriangle, ShapeField.QueryRelation queryRelation);
    ...
    return new ConstantScoreWeight(this, boost) {
      ...
      protected IntersectVisitor getSparseIntersectVisitor(DocIdSetBuilder result) {
        return new IntersectVisitor() {
          final ShapeField.EncodedTriangle scratchTriangle = new ShapeField.EncodedTriangle();
