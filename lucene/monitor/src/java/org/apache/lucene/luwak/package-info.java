 ...
 * {@link org.apache.lucene.luwak.Monitor#match(org.apache.lucene.document.Document, org.apache.lucene.luwak.MatcherFactory)}
 * or in batches via
 * {@link org.apache.lucene.luwak.Monitor#match(org.apache.lucene.document.Document[], org.apache.lucene.luwak.MatcherFactory)}
 *
 * <h3>Matcher types</h3>
 ...
 * <ul>
 *   <li>{@link org.apache.lucene.luwak.QueryMatch#SIMPLE_MATCHER} &mdash; just returns the set of query ids that a Document has matched</li>
 *   <li>{@link org.apache.lucene.luwak.ScoringMatch#matchWithSimilarity(org.apache.lucene.search.similarities.Similarity)}
 *          &mdash; returns the set of matching queries, with the score that each one records against a Document</li>
 *   <li>{@link org.apache.lucene.luwak.ExplainingMatch#MATCHER &mdash; similar to ScoringMatch, but include the full Explanation}</li>
 *   <li>{@link org.apache.lucene.luwak.HighlightsMatch#MATCHER &mdash; return the matching queries along with the matching terms for each query}</li>
 * </ul>
 *
 * Matchers can be wrapped in {@link org.apache.lucene.luwak.PartitionMatcher} or {@link org.apache.lucene.luwak.ParallelMatcher} to increase
 ...
 * {@link org.apache.lucene.luwak.Presearcher}
 *
 ...
 * called a {@link org.apache.lucene.luwak.QueryTree}, and then selects a minimal set of terms, one of which
 * must be present in a document for that document to match.  Individual terms are weighted using a
 * {@link org.apache.lucene.luwak.TermWeightor}, which allows some selectivity when building the term set.
 ...
 * terms.  The {@link org.apache.lucene.luwak.MultipassTermFilteredPresearcher} allows this sort
 ...
 * {@link org.apache.lucene.luwak.CustomQueryHandler} with the presearcher.  Included in this package
 * is a {@link org.apache.lucene.luwak.RegexpQueryHandler}, which gives an example of a different method
 ...
 *
 * By default, {@link org.apache.lucene.luwak.Monitor} instances are ephemeral, storing their query
 * indexes in memory.  To make a persistent monitor, build a {@link org.apache.lucene.luwak.MonitorConfiguration}
 * object and call {@link org.apache.lucene.luwak.MonitorConfiguration#setIndexPath(java.nio.file.Path, org.apache.lucene.luwak.MonitorQuerySerializer)}
 ...
 * {@link org.apache.lucene.luwak.MonitorQuerySerializer} when the index is loaded by a new Monitor
 * instance.
 */
