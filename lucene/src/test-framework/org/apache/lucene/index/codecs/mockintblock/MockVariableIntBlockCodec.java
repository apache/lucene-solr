...
public class MockVariableIntBlockCodec extends Codec {
  ...
  public FieldsConsumer fieldsConsumer(SegmentWriteState state) throws IOException {
    BlockTreePostingsWriterBase postingsWriter = new SepPostingsWriterImpl(state, new MockIntFactory(baseBlockSize));
  ...
  public FieldsProducer fieldsProducer(SegmentReadState state) throws IOException {
    BlockTreePostingsReaderBase postingsReader = new SepPostingsReaderImpl(state.dir,
                                                                           state.segmentInfo,
                                                                           state.context,
