...
public class TestScorerPerf extends LuceneTestCase {
  ...
  public void createDummySearcher() throws Exception {
    ...
    d = newDirectory();
    IndexWriter iw = new IndexWriter(d, newIndexWriterConfig(TEST_VERSION_CURRENT, new WhitespaceAnalyzer(TEST_VERSION_CURRENT)));
  ...
  public void createRandomTerms(int nDocs, int nTerms, double power, Directory dir) throws Exception {
    ...
    IndexWriter iw = new IndexWriter(dir, newIndexWriterConfig(TEST_VERSION_CURRENT, new WhitespaceAnalyzer(TEST_VERSION_CURRENT)).setOpenMode(OpenMode.CREATE));
