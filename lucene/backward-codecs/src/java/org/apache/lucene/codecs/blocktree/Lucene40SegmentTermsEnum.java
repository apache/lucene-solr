...
final class Lucene40SegmentTermsEnum extends TermsEnum {
  ...
  public PostingsEnum postings(PostingsEnum reuse, int flags) throws IOException {
    ...
    if (PostingsEnum.featureRequested(flags, PostingsEnum.OLD_NULL_SEMANTICS) && fr.fieldInfo.getIndexOptions().compareTo(IndexOptions.DOCS_AND_FREQS_AND_POSITIONS) < 0) {
