...
public class Lucene70SegmentInfoFormat extends SegmentInfoFormat {
    ...
    try (ChecksumIndexInput input = dir.openChecksumInput(fileName, context)) {
      ...
      try {
        int format = CodecUtil.checkIndexHeader(input, Lucene70SegmentInfoFormat.CODEC_NAME,
                                                ...
                                                segmentID, "");
        si = readSegmentInfo(new EndiannessReverserIndexInput(input), dir, segment, segmentID);
  ...
  private SegmentInfo readSegmentInfo(IndexInput input, Directory dir, String segment, byte[] segmentID) throws IOException{
