...
public final class OptimizeIndexDialogFactoryImpl implements OptimizeIndexDialogFactory {
  ...
  @Inject
  public OptimizeIndexDialogFactoryImpl(Preferences prefs, IndexToolsFactory indexToolsFactory, IndexHandler indexHandler) {
    this.prefs = prefs;
