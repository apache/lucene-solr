...
public final class AddDocumentDialogFactoryImpl implements AddDocumentDialogFactory, AddDocumentDialogOperator {
  ...
  private JTable fieldsTable() {
    ...
    JComboBox<Class<Field>> typesCombo = new JComboBox<>(presetFieldClasses);
  ...
  private final Class<Field>[] presetFieldClasses = new Class[]{
...
final class FieldsTableModel extends TableModelBase<FieldsTableModel.Column> {
  ...
  public void setValueAt(Object value, int rowIndex, int columnIndex) {
    ...
    if (columnIndex == Column.DEL.getIndex()) {
      ...
      selectedField.setType((Class<? extends Field>) value);
      selectedField.resetFieldType((Class<? extends Field>) value);
