...
public class TestWildcardTermPresearcher extends PresearcherTestBase {
  ...
  public void testFiltersWildcards() throws IOException, UpdateException {
  ...
  public void testNgramsOnlyMatchWildcards() throws IOException, UpdateException {
    try (Monitor monitor = newMonitor()) {
  ...
  public void testCaseSensitivity() throws IOException, UpdateException {
    try (Monitor monitor = newMonitor()) {
