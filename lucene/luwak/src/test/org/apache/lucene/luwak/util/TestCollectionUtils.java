...
public class TestCollectionUtils extends LuceneTestCase {
  ...
  public void testPartitions() {
    ...
    partitions = CollectionUtils.partition(terms, 4);
    ...
    partitions = CollectionUtils.partition(terms, 6);
